...
global.window = jsdom('<html><head></head><body>hello world</body></html>').parentWindow;
global.document = global.window.document;

//require('../../node_modules/jquery/dist/jquery.js')(window);
global.$ = global.jQuery = global.jquery = require('../../bower_components/jquery/jquery.js');
